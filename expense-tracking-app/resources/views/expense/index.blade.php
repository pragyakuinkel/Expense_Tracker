    ...
    <form action="" method="get" class="my-4 mx-3 w-full">
        <div class="flex items-center space-x-4">
            ...
            <input type="text" name="search" placeholder="Search..."
                   class=" px-5 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-[#0ea5e9] focus:border-[#0ea5e9] transition-all duration-200 ease-in-out bg-white text-gray-700  w-[86.5%]" required>
            <button type="submit"
                    class="inline-flex items-center px-5 py-2.5 bg-[#0ea5e9] hover:bg-[#0d84bf] transition-all duration-200 ease-in-out rounded-lg font-semibold text-white shadow-md hover:shadow-lg">
                            ...
                            <div class="space-y-8">
                                @forelse($expenses as $expense)
                                    <div class="flex items-center justify-between pb-6 border-b border-gray-200 transition-all duration-200 hover:bg-gray-50 px-2 rounded-md">
                                        ...
                                        <div class="flex space-x-4">
                                            ...
                                            <a href="{{ route('expense.delete', $expense) }}"
                                ...
                                @empty
                                    <x-empty-value class="text-center text-gray-500 py-12 text-lg">
                                        <i class="fas fa-exclamation-circle mr-2"></i> No Expenses Yet...
                                    </x-empty-value>
                                @endforelse
                            </div>
                        </div>
